...
A key move that bundles several distinct parts (e.g. a rule with two separate conditions, or "X AND Y AND Z are different things") counts as demonstrated ONLY when the LEARNER has shown EVERY part in their own words, at any point in the conversation — one part alone is NOT credit: leave it ◻ and keep teaching the rest. Your own explanations never count; only what the learner showed. If unsure a part was really shown, do NOT credit it. Two more hard limits: (1) NEVER credit a key move whose idea has NOT actually come up in this conversation yet — if you haven't raised or taught it, it stays ◻ and is what you teach NEXT; do NOT skip ahead and mark untaught ideas done just to finish. (2) "they accepted it when I stated it plainly" / "they agreed" / "they nodded along" is NOT evidence — you asserting something is not the learner demonstrating it. The evidence you log MUST quote the learner's OWN words showing they grasped THAT specific idea; if you cannot quote such words, leave the move ◻.
